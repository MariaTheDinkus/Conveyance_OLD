...
public class ConveyanceBlocks {
    ...
    public static void init() {
        BlockRenderLayerMap.INSTANCE.putBlock(CONVEYOR, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(VERTICAL_CONVEYOR, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(DOWN_VERTICAL_CONVEYOR, RenderLayer.getCutout());

        BlockRenderLayerMap.INSTANCE.putBlock(ALTERNATOR, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(SPLITTER, RenderLayer.getCutout());
    }
